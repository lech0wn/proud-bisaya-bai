    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans">
      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <p className="text-center text-sm text-gray-500 mb-12">
          Last updated: <span className="font-medium">March 04, 2021</span>
        </p>
        ...
        <section className="space-y-5 leading-relaxed">
          ...
          <h4 className="font-semibold text-lg mt-6">Personal Data</h4>
          <p>
          ...
          <h4 className="font-semibold text-lg mt-6">Usage Data</h4>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              ...
              <a
                ...
                className="text-[var(--custom-orange)] underline break-all"
              >
          ...
          <ul className="list-disc pl-6 space-y-1 mt-2">
            <li>By email: Proudbisayabai22@gmail.com</li>
            <li>
              By visiting this page on our website:{" "}
              <a
                href="https://proudbisayabai.ph/contact-us"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[var(--custom-orange)] underline"
              >
                https://proudbisayabai.ph/contact/
              </a>
            </li>
            <li>By phone number: 0915-818-4329</li>
          </ul>
        </section>
      </main>
      <Footer />
