    ...
    <div>
        ...
        <section className="mt-10 mb-16">
            ...
            <div className="lg:w-2/3">
                ...
                <span className="font-bold">Proud Bisaya Bai</span> is a Cebu-based 
                media and creative agency dedicated to amplifying authentic Bisaya stories.
                </p>
                
                <p className="text-lg mb-8 max-w-xl">
                We specialize in producing impactful content and campaigns that highlight 
                culture, creativity, and community, serving clients across the country.
                </p>

                <p className="text-lg leading-relaxed">
                Proud Bisaya Bai was founded on July 22, 2020. The ultimate Bisaya lifestyle 
                and culture blog celebrates, promotes, and preserves Bisaya culture through 
                compelling content on travel, food, events, entertainment, and news. What 
                started as a humble platform has grown into a vibrant site powered by a 
                dynamic team of 16 young, creative individuals. We cover more than just 
                Cebu, exploring and amplifying stories from all over the Philippines where 
                Bisaya thrives, with the goal of uniting communities and inspiring pride in 
                our heritage.
                </p>
            </div>
        ...
        <section className="pt-16 relative">
            ...
            <div className="sm:w-1/2 p-4">
                ...
                To inform, inspire, and empower the Bisaya community by promoting cultural 
                pride, local excellence, and authentic experience one story at a time.
                </p>
            </div>
