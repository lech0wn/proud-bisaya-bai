    ...
    <div className="min-h-screen bg-gray-50 p-8 overflow-hidden">
      ...
      <div className="bg-white rounded-lg shadow-sm">
        <div className="border-b border-gray-200 flex items-center justify-between">
          ...
          <div className="flex gap-8 px-6">
              <button
              className="border-b border-gray-200 bg-gray-400 flex items-center gap-2 text-white font-bold px-4 py-2 rounded transition-colors hover:bg-gray-400 active:bg-gray-500">
                Filter
              </button>
              <Link
      ...
      {articles.length === 0 ? (
        <div className="bg-white rounded-lg p-12 text-center">
          <p className="text-black mb-4">No articles found. Feel free to generate!</p>
        </div>
      ) : (
        <div className="max-h-[calc(100vh-400px)] overflow-y-auto scrollbar-overlay">
          <table className="min-w-full table-fixed">
            <thead className="bg-gray-50 sticky top-0 z-10">
              <tr>
                <th className="w-1/6 px-4 py-3 font-bold text-gray-900 text-center align-middle bg-gray-50">Cover</th>
                <th className="w-1/6 px-4 py-3 font-bold text-gray-900 text-center align-middle bg-gray-50">Article Title</th>
                <th className="w-1/6 px-4 py-3 font-bold text-gray-900 text-center align-middle bg-gray-50">Author</th>
                <th className="w-1/6 px-4 py-3 font-bold text-gray-900 text-center align-middle bg-gray-50">Status</th>
                <th className="w-1/6 px-4 py-3 font-bold text-gray-900 text-center align-middle bg-gray-50">Category</th>
                <th className="w-1/6 px-4 py-3 font-bold text-gray-900 text-center align-middle bg-gray-50">Actions</th>
              </tr>
            </thead>
            <tbody>
              {articles.map((a) => (
                <tr key={a.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="w-1/6 px-4 py-3 text-m text-gray-900 text-center align-middle border-b border-gray-200">
                    ...
                    {a.subcategory && (
                      <span className="block text-xs text-gray-500">: {a.subcategory}</span>
                    )}
                  </td>
                  <td className="w-1/6 px-4 py-3 text-m text-gray-900 text-center align-middle border-b border-gray-200">
