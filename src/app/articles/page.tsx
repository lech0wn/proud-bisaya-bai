...
export default async function ArticlesIndexPage() {
  ...
  const categories = [
    ...
    },
    {
      ...
      slug: "destinations",
      count:
        articles?.filter((a) => a.category_slug === "destinations").length || 0,
      subcategories: [
    ...
    },
    {
      ...
      count:
        articles?.filter((a) => a.category_slug === "news-entertainment")
          .length || 0,
      subcategories: [
  ...
  return (
    <ArticlesPageContent articles={articles || []} categories={categories} />
  );
}
